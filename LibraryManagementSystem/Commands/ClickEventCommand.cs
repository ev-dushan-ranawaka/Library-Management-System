...
{
    public class ClickEventCommand : ICommand
    {
        ...
        public ClickEventCommand(Action<object> execute, Predicate<object> canExecute = null)
        {
        ...
        public event EventHandler CanExecuteChanged //It's used to notify the UI that the CanExecute status has changed
        {
